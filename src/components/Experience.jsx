    ...
    <div className="h-fit w-full p-5 md:p-10">
        ...
        <div className="mt-5 block">
          <div className="flex gap-5">
            <div className="">
              <div className="p-1 h-6 w-6 border-1 border-orange-500 flex items-center justify-center rounded-xl">
                <span className="h-3 w-3 bg-orange-400 rounded-xl"></span>
              </div>
              <div className="ml-3 w-0 h-50 border-orange-500 border-l-1"></div>
            </div>
            <div>
              <p>2025 - 2026</p>
