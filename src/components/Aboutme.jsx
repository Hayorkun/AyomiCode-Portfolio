      ...
      <div className=" md:items-center justify-center py-5 md:flex md:gap-6">
        <div className="my-max-width w-full md:flex justify-between gap-5">
          <div className="w-full md:w-[62.5%]">
            <h3 className="mb-3 text-orange-400 font-brand font-semibold leading-relaxed">
              WHO I AM
            </h3>
          ...
          <div className="mt-10 md:w-[37.5%]  w-full border border-orange-300/30 bg-orange-300/10 px-8 py-4 flex flex-col justify-center rounded-xl">
            <div className="w-full">
              <div className="w-full flex justify-between border-b border-orange-400/50 pb-1 mb-5">
                <p className="text-xs">Location</p>
                <h4>Oyo, Nigeria</h4>
              </div>
              <div className="w-full flex justify-between border-b border-orange-400/50 py-1 mb-5">
